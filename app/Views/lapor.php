...
<div id='halaman'>
	...
	<body>
		...
		<hr>
		<form method="POST">
			<textarea id=laporan placeholder="Laporan/Komentar"></textarea>
			<br>
			<select id=aspek placeholder="Pilih Aspek Pelaporan/Komentar">
...
<script>
	function check() {
		...
		var filename = document.getElementById('input-lampiran').value;
	...
	function sendData() {
		...
		xhr.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
				...
				alert("Berhasil Menambahkan Lapor");
